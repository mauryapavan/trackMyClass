...
const LandingPage = () => {
    let navigate=useNavigate();
      async function teachers(params) {
        window.location.href="https://track-my-class.onrender.com"
    }
    return (
        <div className="m-5 p-5 min-h-150 grid  grid-cols-1 items-center justify-items-center-safe text-center    backdrop-blur-md backdrop-brightness-110"  >
            <div className="p-5 flex ">
                <div className="m-5" >
                    <button  className=" p-2  rounded-md bg-green-900 pointer " style={{ color: "whitesmoke" }}> <i><a href="https://track-my-class.onrender.com">Teacher's Login</a></i></button>
